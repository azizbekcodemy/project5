                ...
                <Container>
                    <Box sx={{
                        ...
                        <Box sx={{
                                ...
                                <Link style={{ textDecoration: 'none', height: '100%' }}>
                                    <Box id='NavmenuZzz7'>
                                        ...
                                        <Box id='NavmenuZzz8'>
                                            ...
                                            <Link to="/req" id='NavmenuZzz4'>
                                                Regular Post
                                            </Link>
                                            <Link to="/card" id='NavmenuZzz4'>
                                                Cart
                                            </Link>
                                            <Link to='/contact' id='NavmenuZzz4'>
                                                Contact
                                            </Link>
                                        </Box>
                                    </Box>
                            ...
                            <Box sx={{ marginRight: '30px' }}>
                                <Link to='/blog' id='NavYozuv1'>
                                    Blog
                                </Link>
                            </Box>
                            <Box>
                                <Link to='/contact' id='NavYozuv1'>
                                    Contact
                                </Link>
                            </Box>
                        </Box>
